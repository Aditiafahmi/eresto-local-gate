...
Laravel Local Gate Server
  ...
  ├── store queue and sync status in Redis
...
| Redis | Queue backend, Horizon data, and sync status. |
...
## 13. Face Data Mapping

Input priority:

1. `face_images_base64` when it contains one or more images.
2. No face upload when the array is empty or omitted.
...
## 14. POS Face Enrollment — Planned Phase
